package com.harman.demo.pizzaria.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.harman.demo.pizzaria.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.harman.demo.pizzaria.repository.UserRepository.USERS_BY_EMAIL_CACHE);
