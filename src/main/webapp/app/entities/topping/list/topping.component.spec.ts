...
describe('Topping Management Component', () => {
  let comp: ToppingComponent;
  let fixture: ComponentFixture<ToppingComponent>;
  let service: ToppingService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'topping', component: ToppingComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ToppingComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.toppings?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
